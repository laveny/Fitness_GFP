...
geno_pattern=re.compile("GACAAAGATAGCTTCGCACA(?P<geno>[ATCG]{733})ATAAGCGAATTTCTTATGAT")
umi_pattern=re.compile("TCGCTCTTATTGACCACACC(?P<barcode>[ATCG]{20})GCTTCGGCAGCACATATACT")
